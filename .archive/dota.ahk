...
; Skill by clicking window
q::
IfWinActive, %WINDOW_TITLE%
{
  if on_chat = 0
  {
      Run, "/home/scrubs/PROJECT/wc3dota/.archive/script.sh" "first"
      ; Send {t}
  }
...
IfWinActive, %WINDOW_TITLE%
{
  if on_chat = 0
  {
    Run, "/home/scrubs/PROJECT/wc3dota/.archive/script.sh" "second"
    ; Send {y}
  }
...
IfWinActive, %WINDOW_TITLE%
{
  if on_chat = 0
  {   
    Run, "/home/scrubs/PROJECT/wc3dota/.archive/script.sh" "special"
  }
